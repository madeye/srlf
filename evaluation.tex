...
\end{tabular}
\end{center}
\caption{Comparison between original {\lfea} and LFSR enabled ones. DES refers to {\lfea} time. BLD refers to VOC-Tree building time. QRY includes VOC-Tree query time and RANSAC time. ACY refers to the accuracy of the LFSR enabled retrieval system compared to the original ones.}
